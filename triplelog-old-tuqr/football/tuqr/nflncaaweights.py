...
@interact
def _(cw=slider(sliderarr,default=1),yw=slider(sliderarr,default=1),tw=slider(sliderarr,default=1),iw=slider(sliderarr,default=1),minatt=slider(0,250,1,default=50),maxshow=slider(0,50,1,default=10)):
    xc1 = []
    xc2 = []
    xc3 = []
    xc4 = []
    ...
    print table(sortteams[0:int(min(maxshow,len(sortteams)))])
    @interact
    def _(Completions=slider(0,100,1,default=10),Attempts=slider(0,100,1,default=10),Yards=slider(0,1000,1,default=200),TDs=slider(0,10,1,default=1),INTs=slider(0,10,1,default=0)):
		...
		print "MyNFL: ",round(calcmynflqbrating(stats,cw,yw,tw,iw)[4],2)
		print "MyNCAA: ",round(calcmyncaaqbrating(stats,cw,yw,tw,iw)[4],2)
