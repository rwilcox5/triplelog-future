...
@interact
def _(cw=slider(sliderarr,default=1),yw=slider(sliderarr,default=1),tw=slider(sliderarr,default=1),iw=slider(sliderarr,default=1),minatt=slider(0,250,1,default=50)):
	xc1 = []
	xc2 = []
	xc3 = []
	xc4 = []
